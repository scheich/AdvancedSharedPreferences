...
This library uses the SharedPreferences to save more data types. You can save:

boolean, byte, short, integer, long, biginteger, float, double, bigdecimal, char and string

and

date, gregoriancalendar and location


as single values, arrays or arraylists.
